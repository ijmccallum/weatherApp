...
exports.default = convertToDayArray;
/**
...
function convertToDayArray(hrsArray) {
  var dayArray = [[]];
...
function highestWindSpeedInRange(forecastArray) {
  var speed = Number.NEGATIVE_INFINITY;
  forecastArray.forEach(function (forecast) {
...
function whatDayIsIt(day) {
  ...
  var momentObject = (0, _moment2.default)(day.dt_txt);
  if (momentObject.calendar().includes("Today")) {
    return "Today";
  }
  var dayString = momentObject.format("ddd");
  return dayString;
}

function dataMeta(forecastArray) {
  var meta = {
    list: forecastArray,
...
exports.default = function (threeHrForecasts) {
  var dailyData = (0, _dataHrsToDays2.default)(threeHrForecasts);
  var dailyMetaData = dailyData.map(function (day) {
    return (0, _dataMeta2.default)(day);
  });
  return dailyMetaData;
};

var _dataHrsToDays = require("./dataHrsToDays.js");

var _dataHrsToDays2 = _interopRequireDefault(_dataHrsToDays);

var _dataMeta = require("./dataMeta.js");
...
var _weatherdata = require("./weatherdata.json");

var _weatherdata2 = _interopRequireDefault(_weatherdata);

var _dataPrepper = require("./lib/dataPrepper.js");

var _dataPrepper2 = _interopRequireDefault(_dataPrepper);

var _markupBuilder = require("./lib/markupBuilder.js");

var _markupBuilder2 = _interopRequireDefault(_markupBuilder);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

console.log("weatherData", _weatherdata2.default);

function generateForecastMarkup(forecastArray) {
  //get the "daily data"
  var dailyData = (0, _dataPrepper2.default)(forecastArray);
  console.log("dailyData", dailyData);
  //use that to create the markup
  var forecastMarkup = (0, _markupBuilder2.default)(dailyData);
  //return it!
...
document.getElementById("js-days").innerHTML = generateForecastMarkup(_weatherdata2.default.list);
 ...
 */
var forecastEls = document.querySelectorAll(".js-forecast-btn");
forecastEls.forEach(function (el) {
  console.log("el", el);
